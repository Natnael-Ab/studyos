const iconPaths = {
  ...
  settings: (
    <>
      ...
      <path d="m19.2 14.1 1.2 1.1-1.8 3-1.6-.5a8 8 0 0 1-1.5.9l-.3 1.7h-3.6l-.3-1.7a8 8 0 0 1-1.5-.9l-1.6.5-1.6.5-1.8-3 1.2-1.1a7.8 7.8 0 0 1 0-2.2L5 10.8l1.8-3 1.6.5a8 8 0 0 1 1.5-.9l.3-1.7h3.6l.3 1.7a8 8 0 0 1 1.5.9l1.6-.5 1.6-.5 1.8 3-1.2 1.1a7.8 7.8 0 0 1 0 2.2Z" />
    </>
  ),
  menu: (
    <>
  ...
  eyeOff: (
    <>
      <path d="m3 3 18 18" />
      <path d="M10.6 6.7A9.5 9.5 0 0 1 12 6.5c6 0 9.5 5.5 9.5 5.5a17 17 0 0 1-2.7 3.1" />
      <path d="M6.6 6.8C4 8.2 2.5 12 2.5 12S6 17.5 12 17.5c1.6 0 3-.4 4.2-.9" />
    </>
  )
};
